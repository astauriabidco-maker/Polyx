...
import { Building2, ShieldCheck, Mail, Phone, Globe, Upload, Brain, CheckCircle, AlertTriangle, Key, Zap, RotateCcw } from 'lucide-react';
...
function AIConfigForm({ organisationId }: { organisationId: string }) {
    ...
    const handleTest = async () => {
        ...
        // Save first if there are pending changes (optional, but good UX to ensure we test what is saved)
        if (config.aiApiKey) {
            await handleSave();
        }
