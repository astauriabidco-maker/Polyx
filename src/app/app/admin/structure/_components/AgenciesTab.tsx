...
import { MapPin, Plus, Building2, User, Mail, Phone, Trash2, Edit3, Globe, TrendingUp, Info } from 'lucide-react';
...
export function AgenciesTab() {
    ...
    if (!activeOrganization) return <div className="p-8 text-slate-500">Chargement...</div>;
