...
export default function PipelinePage() {
    ...
    const loadLeads = async () => {
        ...
        if (res.success && res.leads) {
            // Filter for prospection leads - exclude archived and legacy qualified
            // Keep RDV_FIXE for today's appointments display
    ...
    if (isLoading) {
        return <div className="p-8 text-center text-slate-500">Chargement du pipeline...</div>;
    }
